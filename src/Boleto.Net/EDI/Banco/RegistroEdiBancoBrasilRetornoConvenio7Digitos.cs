namespace BoletoNet.EDI.Banco
{
    ...
    /// CBR643
    /// Convênio 7 posições -- Único com Identificação do Registro Detalhe = 7
    /// </summary>
    public class RegistroEdiBancoBrasilRetornoConvenio7Digitos : TRegistroEDI_BancoBrasil_RetornoBase
    {

        public RegistroEdiBancoBrasilRetornoConvenio7Digitos()
        {
            /*
    ...
    /// </summary>
    public class TArquivoBancoBrasilRetornoConvenio7Digitos_EDI : TEDIFile
    {
        /*
        ...
        protected override void DecodeLine(string Line)
        {
            ...
            Lines.Add(new RegistroEdiBancoBrasilRetornoConvenio7Digitos()); //Adiciono a linha a ser decodificada
